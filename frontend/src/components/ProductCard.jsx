    ...
    return (
        ...
        >
            ...
            <Box p={4}>
                ...
                <HStack spacing={2}>
                    <IconButton icon={(<LiaEdit/>)} aria-label={""} onClick={onOpen} colorScheme={"blue"}/>
                    <IconButton icon={(<AiFillDelete/>)} aria-label={""} onClick={() => handleDeleteProduct(product._id)} colorScheme={"red"}/>
                </HStack>
            </Box>
